...
contract Comp {
    ...
    string public constant name = "WAND";
    ...
    // uint public constant maxSupply = 100000000e18;
    // uint public constant bonusV1 = 10000e18;
     ...
     * @param account address recieve bonus for v1
     */
    constructor(uint _chainId, address _owner, address account, uint bonusV1) public {
        balances[account] = bonusV1;
        totalSupply = bonusV1;
        chainId = _chainId;
        owner = _owner;
        emit Transfer(address(0), account, bonusV1);
    }
    ...
    function mint(address _to, uint256 amount) onlyOwner external returns(uint){
    ...
    function transfer(address dst, uint rawAmount) external returns (bool) {
        // uint256 amount = safe96(rawAmount, "Comp::transfer: amount exceeds 96 bits");
    ...
    function transferFrom(address src, address dst, uint rawAmount) external returns (bool) {
        ...
        // uint256 amount = safe96(rawAmount, "Comp::approve: amount exceeds 96 bits");
